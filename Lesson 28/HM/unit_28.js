...
let goods2 = new Goods('Хлеб', 20, 'img/4.png', 1000, '.out-4');
goods2.draw();
 //Task 5.
...
let goods3 = new Goods2('Яд', 200, 'img/4.png', 500, '.out-6', true)
goods3.draw();
...
let user = new Valid('bkmrf@mail.ru', 'bkmas');
user.validate()
...
let user2 = new Valid('bkmrf@mail.ru', 'bkmaasdass');
user2.validate()
...
console.log(valid2);
 ...
 let valid3 = new Valid2('adad', 'asdqwes')
 valid3.validate();
 console.log(valid3);
