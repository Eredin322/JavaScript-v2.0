...
document.querySelector('.three').innerHTML = '<h3>Произвольный H3 Заголовок</h3>';
...
document.querySelector('.four').innerHTML = '<h4>h4 заголовок</h4>';
document.querySelector('.four').innerHTML += '<p>Дописываем к заголовку</p>';
