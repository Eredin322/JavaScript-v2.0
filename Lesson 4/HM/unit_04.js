...
function f6() {
    ...
    document.querySelector('.b-6').onclick = () => {
        document.querySelector('.out-6').innerHTML = a.value;
    }
}
...
function f8() {
    ...
    let btn1 = document.querySelector('.b-8').onclick = () => {
        a.innerHTML = "<input type='text' class='i-81' value='Сработало!'/>";
        a.innerHTML += "<button class='b-81'></button>";
        let btn2 = document.querySelector('.b-81');
...
function f81 () {
    let b = document.querySelector('.i-81');
    document.querySelector('.out-81').innerHTML = b.value;
...
function f10() {
    ...
    document.querySelector('.out-10').style.background = a.value;
}
...
function f15() {
    ...
    t.value = i.value;
    document.querySelector('.out-15').innerHTML = i.value;
}
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = s.value;
}
...
function f19() {
    let a = document.querySelector('.i-191');
    let b = document.querySelector('.i-192');
    document.querySelector('.out-19').innerHTML = a.value + " " + b.value;
}
